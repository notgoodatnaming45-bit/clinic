...
#         {
#             "id": str(p.id),
#             "first_name_encrypted": p.first_name_encrypted,
#             "last_name_encrypted": p.last_name_encrypted,
#             "date_of_birth_encrypted": p.date_of_birth_encrypted,
#             "mrn": p.mrn,
#             "case_status": p.case_status.value,
#             "priority": p.priority.value,
#             "injury_date": str(p.injury_date) if p.injury_date else None,
#             "assigned_physician_id": str(p.assigned_physician_id)
#             if p.assigned_physician_id
#             else None,
